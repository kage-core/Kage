...
<img src="../docs/kage-viewer.jpg" alt="kage viewer의 메모리↔코드 맵: 메모리 packet이 근거가 되는 코드 파일에 연결됨" width="760">

<sub>`kage viewer`의 메모리 ↔ 코드 맵: 각 메모리 packet(보라)이 근거가 되는 파일(파랑)에 연결됩니다.</sub>
