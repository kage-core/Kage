...
2. Receipts. Every memory records what it cost to learn (tokens), and every recall prints what it saved you — measured, not estimated. "kage gains" shows the running ledger.
...
GPL-3.0. 241 tests. Young project — I'd genuinely value the hard questions, especially from anyone who's been burned by an agent trusting stale context.
