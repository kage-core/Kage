...
### Memory for coding agents — that you can trust
...
2. **Capture as it works.** Durable learnings become packets. A memory that cites a file
   which doesn't exist is rejected on the spot — hallucinations never enter storage.
...
- **Trust benchmark:** 100/100 — hallucination rejection, stale exclusion, live grounding
